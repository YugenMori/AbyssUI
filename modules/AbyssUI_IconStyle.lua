...
local function OldSchoolTheme() 
    Abconfig.textures = {
    normal            = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\abyssuiborder",
    bags              = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\abyssuiborder",
    flash             = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\flash",
    hover             = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\hover",
    pushed            = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\pushed",
    checked           = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\checked",
  ...
  Abconfig.buffFrame = {
    ...
    border = {
      texture           = "Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\abyssuiborder",
      color             = { r = 0.5, g = 0.5, b = 0.5, },
      classcolored      = false,
    },
    background = {
...
local function IconBackInit()
  ...
  local function applyBackground(bu)
    ...
    -- bu.bg:SetAllPoints(bu)
      ...
      if Abconfig.background.showbg and not Abconfig.background.useflatbackground then
        ...
        --t:SetAllPoints(bu)
        AbyssUI_ColorizationFrameFunction(t)
      end
  ...
  local function styleLeaveButton(bu)
    ...
    AbyssUI_ColorizationFrameFunction(bo)
    bo:ClearAllPoints()
    bo:SetAllPoints(bu)
    --shadows+background
    if not bu.bg then applyBackground(bu) end
  ...
  local function applySkin(b)
    ...
    border:SetTexture("Interface\\AddOns\\AbyssUI\\textures\\iconstyle\\abyssuiborder")
