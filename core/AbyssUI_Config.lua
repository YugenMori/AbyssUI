...
--
AbyssUI_Config.childpanel7 = CreateFrame("Frame", "$parentConfigChild_Thanks&Translations", AbyssUI_Config.panel)
AbyssUI_Config.childpanel7.name = L["Thanks & Translations"]
...
-- Panel 08 (Thanks)
local Frame = CreateFrame("Frame","$parentFrameButtonPanel08", AbyssUI_Config.childpanel7)
...
----------------------------------- Thanks & Translations  -----------------------------------
local PSINFOThanks_CheckButton = CreateFrame("Frame","$parentPSINFOThanks_CheckButton", AbyssUI_Config.childpanel7)
PSINFOThanks_CheckButton:SetPoint("BOTTOMLEFT", AbyssUI_Config.childpanel7, "BOTTOMLEFT", 10, 20)
...
-- Special Thanks
local Frame = CreateFrame("Frame","$parentFrameThanks", AbyssUI_Config.childpanel7)
Frame:SetPoint("TOPLEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 0, -60)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
Frame:SetText(L["|cff0d75d4Special Thanks|r"])
local Frame1 = CreateFrame("Frame","$parentFrameThanks", AbyssUI_Config.childpanel7)
Frame1:SetPoint("TOPLEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -80)
Frame1:SetWidth(600)
Frame1:SetHeight(40)
...
local Frame2 = CreateFrame("Frame","$parentFrameThanks", AbyssUI_Config.childpanel7)
Frame2:SetPoint("TOPLEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -100)
Frame2:SetWidth(600)
Frame2:SetHeight(40)
...
-- Translations
local Frame = CreateFrame("Frame","$parentFrameThanks", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 0, -200)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
...
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -230)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
...
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -260)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
Frame:SetJustifyV("LEFT")
Frame:SetJustifyH("LEFT")
Frame:SetText(L["|cfff2dc7fSpanish (Mexico): |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -290)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
...
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -320)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
Frame:SetJustifyV("LEFT")
Frame:SetJustifyH("LEFT")
Frame:SetText(L["|cfff2dc7fGerman: |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -350)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
...
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", 10, -380)
Frame:SetWidth(600)
Frame:SetHeight(40)
Frame = Frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
Frame:SetAllPoints()
Frame:SetJustifyV("LEFT")
Frame:SetJustifyH("LEFT")
Frame:SetText(L["|cfff2dc7fSpanish (Spain): |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -230)
Frame:SetWidth(600)
...
Frame:SetText(L["|cfff2dc7fFrench: |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -260)
Frame:SetWidth(600)
...
Frame:SetJustifyV("RIGHT")
Frame:SetJustifyH("RIGHT")
Frame:SetText(L["|cfff2dc7fItalian: |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -290)
Frame:SetWidth(600)
...
Frame:SetJustifyV("RIGHT")
Frame:SetJustifyH("RIGHT")
Frame:SetText(L["|cfff2dc7fRussian: |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -320)
Frame:SetWidth(600)
...
Frame:SetJustifyV("RIGHT")
Frame:SetJustifyH("RIGHT")
Frame:SetText(L["|cfff2dc7fKorean: |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -350)
Frame:SetWidth(600)
...
Frame:SetJustifyV("RIGHT")
Frame:SetJustifyH("RIGHT")
Frame:SetText(L["|cfff2dc7fChinese (Traditional): |r"]..L["Google Translate"])
--
local Frame = CreateFrame("Frame","$parentFrameTranslations", AbyssUI_Config.childpanel7)
Frame:SetPoint("LEFT", AbyssUI_Config.childpanel7, "TOPLEFT", -10, -380)
Frame:SetWidth(600)
...
Frame:SetJustifyV("RIGHT")
Frame:SetJustifyH("RIGHT")
Frame:SetText(L["|cfff2dc7fChinese (Simplified): |r"]..L["Google Translate"])
----------------------------- AbyssUI Stylization ------------------------------
