...
local function InitSettings()
  ...
  f:SetScript("OnEvent", function() 
    ...
    FrameButton:SetScript("OnClick", function()
        AbyssUI_EditBox:SetText("https://discord.gg/Z4HSHZrYUK")
  ...
  f:SetScript("OnEvent", function() 
    ...
    FrameButton:SetScript("OnClick", function()
      AbyssUI_EditBox:SetText("https://ko-fi.com/yugensan")
      AbyssUI_EditBox_Frame:Show()
    end)
  end)
  -- Github
...
if (GetWoWVersion >= 50600 and GetWoWVersion <= 90500) then
  ...
  HideRunePower_CheckButton:SetChecked(AbyssUIAddonSettings.RunePower)
  -- OnClick Function
  HideRunePower_CheckButton:SetScript("OnClick", function(self)
    AbyssUIAddonSettings.RunePower = self:GetChecked()
      if (AbyssUIAddonSettings.RunePower == true ) then
        if (RuneFrame) then
          RuneFrame:Hide()
        end
